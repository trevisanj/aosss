...
#     l0, lf = 3000, hpd.get_ubv_bandpass("K").lf
...
#     # # bands
#     #   =====
#     for band_name, bandpass in hpd.get_ubv_bandpasses_dict().items():
...
class RedshiftWindow(QMainWindow):
    ...
    def redraw(self):
        try:
            ...
            hpd.get_python_logger().exception("Could not draw figure")
...
if __name__ == "__main__":
    ...
    #     try:
    #         fileobj = hpd.FileSpectrumFits()
    #         fileobj.load(path_)
    #         telluric_spectra.append(fileobj.spectrum)
    #     except:
    #         hpd.get_python_logger().exception("Failed to load '%s'" % path_)
    #
    # # Loads telluric features
    # telluric_filenames = ["telluric-5000-10000.fits", "atmos_S_H.fits",
    #  "atmos_S_J.fits", "atmos_S_K.fits", "atmos_S_SZ.fits"]
    ...
    try:
        ...
        hpd.get_python_logger().exception("Failed to load ESO sky model")
